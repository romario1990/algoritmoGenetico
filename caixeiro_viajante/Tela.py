...
class CarregarInformacoes(t.Frame):
    ...
    def salvarVertice(self):
        ...
        tPopulacao = self.tamanhoPopulacao.get()
        tMutacao = self.taxaMutacao.get()
        tCruzamento = self.taxaCruzamento.get()
        iteracoes = self.iteracoes.get()
        mostrar = self.mostrar.get()
